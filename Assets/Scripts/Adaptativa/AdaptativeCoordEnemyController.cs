...
public class AdaptativeCoordEnemyController : MonoBehaviour
{
    ...
    public void SetState(int behaivior)
    {
        switch (behaivior)
        {
            case 0:
                this.behaviour = EnemyBehaviour.atacker; 
                break;
            case 1:
                this.behaviour = EnemyBehaviour.surrounder;
                break;
            case 2:
                this.behaviour = EnemyBehaviour.waiter;
                break;
        }
    }
